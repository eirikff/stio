...
namespace svo
{
    namespace ceres_backend_factory
    {
                                               ...
                                               const CameraBundlePtr &camera_bundle)
        {
            ...
            backend_options.remove_fixation_min_num_fixed_landmarks_ = static_cast<size_t>(vk::param<int>(pnh, "ceres_remove_fixation_min_num_fixed_points", 10u));
            backend_options.max_fixed_lm_in_ceres_ = static_cast<size_t>(vk::param<int>(pnh, "ceres_max_fixed_landmarks", 50u));
