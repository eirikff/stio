...
namespace svo
{
  ...
  Visualizer::Visualizer(const std::string &trace_dir,
      ...
      : pnh_(nh_private), trace_dir_(trace_dir), img_pub_level_(vk::param<int>(pnh_, "publish_img_pyr_level", 0)), img_pub_nth_(vk::param<int>(pnh_, "publish_every_nth_img", 1)), dense_pub_nth_(vk::param<int>(pnh_, "publish_every_nth_dense_input", 1)), viz_caption_str_(vk::param<bool>(pnh_, "publish_image_caption_str", false)), pc_(new PointCloud), publish_world_in_cam_frame_(
        ...
        publish_seeds_(vk::param<bool>(pnh_, "publish_seeds", true)), publish_seeds_uncertainty_(
                                                                          vk::param<bool>(pnh_, "publish_seeds_uncertainty", false)),
        publish_active_keyframes_(
            vk::param<bool>(pnh_, "publish_active_kfs", false)),
        trace_pointcloud_(vk::param<bool>(pnh_, "trace_pointcloud", false)), vis_scale_(vk::param<double>(pnh_, "publish_marker_scale", 1.2))
  {
