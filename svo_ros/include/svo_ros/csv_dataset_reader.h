  ...
  namespace dataset
  {
    ...
    struct ImuMeasurement : public MeasurementBase
    {
      ...
      ImuMeasurement(
          ...
          : MeasurementBase(timestamp_nanoseconds, MeasurementType::kImu), acc_gyro_measurement(acc_gyro_measurement)
      {
      }
    ...
    struct CameraMeasurement : public MeasurementBase
    {
      ...
      CameraMeasurement(
          int64_t timestamp_nanoseconds, size_t camera_index, const std::string &image_path_filename)
          : MeasurementBase(timestamp_nanoseconds, MeasurementType::kCamera), camera_index(camera_index), image_path_filename(image_path_filename)
      {
      }
    ...
    struct FeatureTrackMeasurement : public MeasurementBase
    {
      ...
      FeatureTrackMeasurement(
          ...
          : MeasurementBase(timestamp_nanoseconds, MeasurementType::kFeatureTrack), camera_index(camera_index), track_id(track_id), keypoint_measurement(keypoint_measurement), keypoint_std_dev(keypoint_std_dev)
      {
      }
