...
namespace svo
{
  namespace test_utils
  {
    ...
    {
      return px[0] >= 0 && px[1] >= 0 && px[0] < image_width && px[1] < image_height;
    }
    ...
    {
      return px[0] >= margin && px[1] >= margin && px[0] < (image_width - margin) && px[1] < (image_height - margin);
    }
    ...
    {
      return x >= margin && y >= margin && x < (image_width - margin) && y < (image_height - margin);
    }
    // -----------------------------------------------------------------------------
