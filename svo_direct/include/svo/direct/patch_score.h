    ...
    public:
      ...
      ZMSSD(PATCH_TYPE *ref_patch) : ref_patch_(ref_patch)
      {
        ...
        if (patch_size_ == 0)
        {
          ...
          sumA_ = vget_lane_u16(sumAx4, 0) + vget_lane_u16(sumAx4, 1) + vget_lane_u16(sumAx4, 2) + vget_lane_u16(sumAx4, 3);
