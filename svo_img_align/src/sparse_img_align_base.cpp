...
namespace svo
{
  ...
  SparseImgAlignBase::SparseImgAlignBase(
      ...
      : vk::solver::MiniLeastSquaresSolver<8, SparseImgAlignState, SparseImgAlignBase>(optimization_options), options_(options), weight_function_(options_.robustification ? (new vk::solver::TukeyWeightFunction) : nullptr), weight_scale_(options_.weight_scale)
  {
  }
